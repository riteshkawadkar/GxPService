...
CallerIsTrustedService() {
    ...
    if (A_Args.Length() > 0 && A_Args[1] = "a13e07c188ba1fd889773096e0bfeccf") {
        ...
        RegRead, trustedLaunch, HKEY_LOCAL_MACHINE, Software\VShield\GxPService\Agents\ribbon11, TrustedLauncher
        ...
        if (trustedLaunch = "true") {
			...
			RegWrite, REG_SZ, HKEY_LOCAL_MACHINE, Software\VShield\GxPService\Agents\ribbon11, TrustedLauncher, false
            return true
        }
    }
    return false
...
loop
{
	...
	if ((class = "CabinetWClass" or class = "WorkerW" or class = "Progman") and DisableRibbon=1)
	{
		...
		;ToolTip, Disabling control
		;Control, Disable ,, Windows.UI.Composition.DesktopWindowContentBridge1, %Title%
		Control, Disable ,, Windows.UI.Composition.DesktopWindowContentBridge2, %Title%
		Control, Disable ,, Microsoft.UI.Content.DesktopChildSiteBridge1, %Title%
	}
